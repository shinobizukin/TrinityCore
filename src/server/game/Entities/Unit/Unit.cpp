...
{
    TC_LOG_DEBUG("entities.unit","Casting spell...");
    ...
    TC_LOG_DEBUG("entities.unit","Spell initialized");
    for (auto const& pair : args.SpellValueOverrides)
        spell->SetSpellValue(pair.first, pair.second);

    TC_LOG_DEBUG("entities.unit","Spell overrides");
    spell->m_CastItem = args.CastItem;
    TC_LOG_DEBUG("entities.unit","set cast item");
    spell->prepare(targets, args.TriggeringAura);
    TC_LOG_DEBUG("entities.unit","Spell prepare");
}
