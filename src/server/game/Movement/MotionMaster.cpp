...
void MotionMaster::MoveFollow(Unit* target, float dist, ChaseAngle angle, bool allignToTargetSpeed, bool faceTarget, MovementSlot slot)
{
    ...
    Mutate(new FollowMovementGenerator(target, dist, angle, allignToTargetSpeed, faceTarget), slot);
}
